    ...
    public static class Program
    {
        ...
        private static void Main()
        {
            while(true)
            {
                ...
                Console.WriteLine();
                using (Game1 game = new Game1(typeOne, typeTwo, (Ship winner, Ship loser) => { Program.winner = winner; Program.loser = loser; }))
                {
                    game.Run();
                }
                if (winner == null)
                ...
                else
                {
                    ...
                    for (int i = 0; i < 2; ++i)
                    {
                        ...
                        WriteInColor($"{ ((float)ship.ShotsHit / ship.ShotsFired) * 100 }%\n", ConsoleColor.Yellow);
